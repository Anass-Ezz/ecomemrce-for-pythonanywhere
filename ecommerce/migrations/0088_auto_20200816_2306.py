...
class Migration(migrations.Migration):
    ...
    dependencies = [
        ('ecommerce', '0087_auto_20200816_1352'),
    ]
    ...
    operations = [
        migrations.AlterField(
            model_name='order',
            name='status',
            field=models.CharField(choices=[('c', 'consulting'), ('w', 'working on'), ('s', 'shipping')], default='c', max_length=100),
        ),
        migrations.AlterField(
        ...
        migrations.AlterField(
            model_name='product',
            name='add_date',
            field=models.DateTimeField(default=datetime.datetime(2020, 8, 16, 23, 6, 51, 430600)),
        ),
        migrations.AlterField(
